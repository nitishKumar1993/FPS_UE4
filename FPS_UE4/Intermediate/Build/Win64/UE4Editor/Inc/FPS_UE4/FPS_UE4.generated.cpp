...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	UFunction* Z_Construct_UFunction_AFPS_UE4Projectile_OnHit()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("OnHit"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x00C20401, 65535, sizeof(FPS_UE4Projectile_eventOnHit_Parms));
			...
			UProperty* NewProp_NormalImpulse = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("NormalImpulse"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(NormalImpulse, FPS_UE4Projectile_eventOnHit_Parms), 0x0010000000000080, Z_Construct_UScriptStruct_FVector());
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_AFPS_UE4Projectile_OnHit(), "OnHit"); // 3465996127
				OuterClass->ClassConfigName = FName(TEXT("Game"));
	...
	IMPLEMENT_CLASS(AFPS_UE4Projectile, 4161497773);
